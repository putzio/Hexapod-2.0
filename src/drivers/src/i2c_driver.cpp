#include "../inc/i2c_driver.hpp"

I2C_driver::I2C_driver(i2c_inst_t* i2c_instance, uint32_t baudRate, uint8_t i2cPins[2]) {
...
uint8_t I2C_driver::Read(uint8_t adress, uint8_t* dataBufferPtr, size_t numberOfbytes, bool noStop, absolute_time_t maxBlockingTime_us) {
    return i2c_read_timeout_us(m_i2c_instance, adress, dataBufferPtr, numberOfbytes, noStop, maxBlockingTime_us);
}

uint8_t I2C_driver::Write(uint8_t adress, uint8_t* dataBufferPtr, size_t numberOfbytes, bool noStop, absolute_time_t maxBlockingTime_us) {
